...
const ARGUMENTE = [
  {
    ...
    text: 'Breakdance, Skateboarding, Klettern, Surfen – das IOC hat in den letzten Jahren konsequent neue Sportarten aufgenommen, um jüngere und urbanere Zielgruppen zu erreichen. Paris durfte Breakdance selbst vorschlagen. Und was wäre urbaner, norddeutscher und origineller als Trommelschiessen?',
    emoji: '🏛️',
  },
  {
    nr: '02',
    titel: 'Klare Regeln, faire Chancen',
    text: 'Trommelschiessen hat ein präzises Regelwerk: 3 Meter Abstand, Elfmeter-Duell, Ball muss in der Trommel liegen bleiben. Keine Interpretation, kein Schiedsrichter-Ermessen. Die Sieger-Entscheidung ist glasklarer als beim Eiskunstlauf, beim Turnen – oder beim Breakdance, wo Kreativität und Persönlichkeit bewertet werden.',
    emoji: '📐',
  },
  {
    nr: '03',
    titel: 'Minimaler Infrastrukturaufwand',
    text: 'Olympia bedeutet Milliarden für Sportstätten. Trommelschiessen braucht eine Waschmaschine, einen Fußball und 3 Meter freie Fläche. Die Arena lässt sich in jedem Hinterhof aufbauen – klimaneutral, nachhaltig, ohne Betonsünden. Das IOC wäre begeistert. Der Zukunftsrat auch.',
    emoji: '♻️',
  },
  {
    nr: '04',
    titel: 'Ein Sport aus dem Volk',
    text: 'Trommelschiessen wurde nicht in einem Sportverband erdacht. Es entstand spontan, in einer WG, weil ein Softball und eine Waschmaschine zur gleichen Zeit am gleichen Ort waren. Das ist die Geschichte, die Olympia seit Jahren sucht. Nicht Kader, nicht Fördergelder, nicht Verbandspolitik. Einfach Sport.',
    emoji: '⚓',
  },
  {
    nr: '05',
    titel: 'Zuschauer-Garantie',
    text: 'Rudern um 7 Uhr morgens. Schießen mit Luftgewehr. Moderner Fünfkampf schaut niemand. Trommelschiessen hingegen hat seit 2006 bewiesen: Es zieht Zuschauer an, es erzeugt Lacher, Spannung und echte Emotionen. Ein Trommelschiessen-Finale in einem ausverkauften Stadion – keine Utopie.',
    emoji: '🎪',
  },
  {
    nr: '06',
  ...
  },
  {
    ...
    text: 'Trommelschiessen erfordert keine besondere Körpergröße, kein Startkapital, keine jahrelange Vereinsmitgliedschaft. Ein Ball, eine Maschine, fünf Schüsse. Jeder kann mitmachen. Das IOC kämpft seit Jahren für mehr Inklusion im Sport. Trommelschiessen ist die Antwort.',
    emoji: '🤝',
  },
]

const VERGLEICHE = [
  { sport: 'Rhythmische Sportgymnastik', grund: 'Seit 1984 olympisch. Hauptsächlich in Osteuropa gespielt. Bewertet nach Ästhetik.', trommel: 'Trommelschiessen: Klares Ergebnis. Ball drin oder nicht.' },
  { sport: 'Breakdance (Paris 2024)', grund: 'Einmalig olympisch auf Antrag des Gastgebers. Bewertung nach Kreativität, Persönlichkeit und Musikalität.', trommel: 'Trommelschiessen: Auch Gastgeber-Antrag möglich. Bewertung: null oder eins.' },
  { sport: 'Moderner Fünfkampf', grund: 'Kombination aus Schwimmen, Fechten, Reiten, Laufen und Schießen. Pferdelose Länder strukturell benachteiligt.', trommel: 'Trommelschiessen: Keine Pferde. Keine Benachteiligung. Waschmaschine reicht.' },
  { sport: 'Synchronschwimmen', grund: 'Olympisch seit 1984. Lange nur für Frauen. Bewertung subjektiv.', trommel: 'Trommelschiessen: Offen für alle Geschlechter. Mixed-Event von Anfang an.' },
]
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 48, alignItems: 'start' }}>
            <div>
              <h2 style={{ fontSize: 'clamp(24px, 3vw, 38px)', color: 'var(--gruen)', marginBottom: 20, lineHeight: 1.2 }}>
                Das IOC hat Breakdance aufgenommen.<br />Warum nicht Trommelschiessen?
              </h2>
            </div>
            <div>
              <p style={{ fontSize: 16, lineHeight: 1.9, color: 'var(--text)', marginBottom: 20 }}>
                Paris 2024 hat bewiesen: Gastgeberstädte dürfen eigene Sportarten vorschlagen. Das Internationale Olympische Komitee hat Breakdance, Skateboarding, Sportklettern und Surfen ins Programm aufgenommen – allesamt Sportarten, die außerhalb ihrer Communities kaum jemand kannte. Trommelschiessen ist älter, präziser und deutlich norddeutschaffener.
              </p>
              <p style={{ fontSize: 16, lineHeight: 1.9, color: 'var(--text)', marginBottom: 20 }}>
      ...
      <section style={{ background: 'var(--gruen)', padding: '80px 0' }}>
        <div className="container">
          ...
          <h2 style={{ fontSize: 'clamp(24px, 3vw, 40px)', color: 'white', marginBottom: 12 }}>
            Trommelschiessen vs. bereits olympische Sportarten
          </h2>
            ...
            {VERGLEICHE.map((v, i) => (
              <div key={i} style={{
                ...
                <div style={{ borderLeft: '1px solid rgba(255,255,255,0.1)', paddingLeft: 24 }}>
                  <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase', color: 'var(--gold)', marginBottom: 6 }}>Trommelschiessen</div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 40, alignItems: 'center' }}>
            <div>
              ...
              <p style={{ fontSize: 15, lineHeight: 1.9, color: 'var(--text)' }}>
                Frankreich hat Breakdance olympisch gemacht, weil es eine urbane Kulturbewegung des Gastgeberlandes war. Trommelschiessen ist die urbane Kulturbewegung Norddeutschlands. Irgendwo in Norderstedt wartet eine Waschmaschine auf ihren großen Auftritt.
              </p>
            </div>
        ...
        <div className="container" style={{ textAlign: 'center' }}>
          <div style={{ maxWidth: 680, margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
              <Link to="/info/historie" className="btn btn--primary">Die Geschichte des Trommelschiessens</Link>
